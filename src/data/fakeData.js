...
export const groupChatMembers = {
  1: [
    ...
    { id: 'sophie', name: 'Sophie L.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Sophie&backgroundColor=f5d5e8' },
    { id: 'romain', name: 'Romain B.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Romain&backgroundColor=d5e8f5' },
    { id: 'yasmine', name: 'Yasmine K.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Yasmine&backgroundColor=f5f0d5' },
    { id: 'hugo', name: 'Hugo M.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Hugo&backgroundColor=d5f5f0' },
    { id: 'clara', name: 'Clara V.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Clara&backgroundColor=f0d5f5' },
    { id: 'kevin', name: 'Kévin A.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Kevin&backgroundColor=e0f5d5' },
    { id: 'margot', name: 'Margot T.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Margot&backgroundColor=f5e0d5' },
    { id: 'nathan', name: 'Nathan S.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Nathan&backgroundColor=d5e0f5' },
    { id: 'ines', name: 'Inès D.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Ines&backgroundColor=f5d5d5' },
    { id: 'adrien', name: 'Adrien C.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Adrien&backgroundColor=d5f5d5' },
    { id: 'manon', name: 'Manon G.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Manon&backgroundColor=e8e0f5' },
    { id: 'samir', name: 'Samir H.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Samir&backgroundColor=f5e8d0' },
    { id: 'oceane', name: 'Océane P.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Oceane&backgroundColor=d0f5e8' },
  ],
  2: [
    { id: 'amina', name: 'Amina', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Amina&backgroundColor=ffd5dc', isCreator: true },
    ...
    { id: 'lucas', name: 'Lucas M.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Lucas&backgroundColor=c0e8ff' },
    { id: 'pauline', name: 'Pauline B.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Pauline&backgroundColor=f5d5f0' },
    { id: 'mehdi', name: 'Mehdi L.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Mehdi&backgroundColor=d5d5f5' },
    { id: 'alice', name: 'Alice D.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Alice&backgroundColor=f5f5d5' },
    { id: 'florian', name: 'Florian R.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Florian&backgroundColor=d5f0f5' },
    { id: 'sarah', name: 'Sarah N.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Sarah&backgroundColor=f5e0e0' },
    { id: 'benjamin', name: 'Benjamin K.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Benjamin&backgroundColor=e0f5e0' },
    { id: 'nina', name: 'Nina C.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Nina&backgroundColor=e0e0f5' },
    { id: 'tom', name: 'Tom W.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Tom&backgroundColor=f5e8e0' },
    { id: 'lina', name: 'Lina A.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Lina&backgroundColor=e0f5e8' },
    { id: 'antoine', name: 'Antoine F.', avatar: 'https://api.dicebear.com/9.x/avataaars/svg?seed=Antoine&backgroundColor=f0e0f5' },
  ],
}
